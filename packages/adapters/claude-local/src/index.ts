...
- resumeSessions (boolean, optional, default false): resume the saved Claude session on later heartbeats of the same task when prompt bundle, MCP server set and cwd all match. Off by default; enable per agent.
